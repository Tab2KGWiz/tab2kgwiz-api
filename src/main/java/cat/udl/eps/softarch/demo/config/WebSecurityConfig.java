    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/mappings").hasRole("SUPPLIER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/userontologylists").hasRole("SUPPLIER")
                        .requestMatchers(HttpMethod.POST, "/userontologylists").hasRole("SUPPLIER")
                        .requestMatchers(HttpMethod.GET, "/verify-token").permitAll()
                        .requestMatchers(HttpMethod.POST, "/ontology/load").permitAll()
